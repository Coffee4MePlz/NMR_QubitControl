...
data = np.loadtxt('xShape_(1Xsy)_NP-200_Opt34_Obs.RF', comments="#", usecols=(0, 1)) # for actual data
...
ax1.set_title('Phase_Obs')
ax2.set_title('Amplitude_Obs')
ax1.set_ylim([0,360])
ax2.set_ylim([0,1124])
ax2.set_xlabel('Pulse Time (us)')
